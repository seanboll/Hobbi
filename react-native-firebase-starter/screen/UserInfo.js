...
export default class HomePage extends React.Component {
  ...
  componentDidMount() {
    ...
    itemsRef.on('value', snapshot => {
      ...
      let animal = data.spiritAnimal;
      this.setState({ name:userName, age:userAge, location:userLocation, aboutMe:userMe, funFact:userFun, animal:animal });
    })
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style = {styles.profileBioHeader}>
          ...
          Spirit Animal: {this.state.animal}
