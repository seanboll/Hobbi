...
export default class HomePage extends React.Component {
  state =  {  name: '', age: 0, location: '', aboutMe: '', funFact: '', spiritAnimal: '', selectedHobbies: [], recommendedList: [], placement: 0, images: {}}
  ...
  componentDidMount() {
    ...
    let userHobbies = [];
    //let myList = []
    this.setState({ name:userName, age:userAge, location:userLocation, aboutMe:userMe, funFact:userFun, spiritAnimal:userAnimal, selectedHobbies: userHobbies, recommendedList: userList, placement:myPlacement, images: userImages});
    ...
    return (
      <View
        ...
        <TouchableHighlight
         ...
         onPress={() => this.props.navigation.navigate('HomePage1', {name: this.state.recommendedList[(this.state.placement + 1) % this.state.recommendedList.length], placement: this.state.placement + 1})}>
