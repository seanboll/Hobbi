      ...
      <View
        ...
        <TouchableHighlight
         ...
         onPress={() => this.props.navigation.navigate('HomePage', {name: this.state.recommendedList[this.state.placement], placement: this.state.placement, matches: this.state.currentlyMatched})}>
          <Image source = {require('../assets/Events_switch.png')}
            style = {styles.Event} />
        </TouchableHighlight>
        ...
        <Image source = {require('../assets/image_stone_summit.png')}
        ...
        <Text style = {styles.profileBio}>
          ...
          {"\n"}
          {"\n"}
          <Text style = {styles.profileBio1}>OCT </Text><Text style = {styles.profileBio2}>      5pm - 7pm, Stone Summit </Text>
          <Text style = {styles.profileBio1}>{"\n"} 18</Text> <Text style = {styles.profileBio2}>                         Midtown </Text>
        </Text>
